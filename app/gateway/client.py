...
GATEWAY_CONFIG = {
    ...
    "cache": {"mode": "simple"},
    "retry": {"attempts": 2, "on_status_code": [429, 503]},
    "targets": [
        {
            "override_params": {
        ...
        {"override_params": {"model": f"@{settings.GROQ_SLUG2}/openai/gpt-oss-20b"}},
    ],
}

portkey_client = Portkey(api_key=settings.PORTKEY_API_KEY, config=settings.PORTKEY_CONFIG)
...
def extract_cache_status(response) -> str:
    ...
    return headers.get("cache-status", "MISS").upper()
